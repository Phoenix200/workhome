...
//    static final String accessKeySecret = "B3BZSQDnuUnfZXf22bbovyPaJmCNDt";
    static final String accessKeyId = "LTAIrFO0hfbnpx57";//LTAIlefATxsjTNoL
    static final String accessKeySecret = "OKTavJo8lp4aVLbPVZg6gMKuu1BUaT"; //zhzDVzH1KjqeZZVOHsTsqfjApi0HJJ
    ...
    public static SendSmsResponse sendSms(String telephone,String name, String code ,String address , String phone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("千凰");			//老袁a洗脚6
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_144851655"); 	//SMS_85550034
