...
SVGElement.prototype = {
	...
	colorGradient: function (color, prop, elem) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same controller object is created within this renderer
			if (gradients[key]) {
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 *
	 * @param {Object} color The color or controller object
	 */
...
Axis.prototype = {
	...
	/**
	 * The default label formatter. The context is a special controller object for the label.
	 */
...
Chart.prototype = {
	...
	/**
	 * Create the Axis instances based on the controller options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
	...
	/**
	 * Show chart credits based on controller options
	 */
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original controller options for
	...
	getAttribs: function () {
		...
		if (!turboThreshold || i < turboThreshold || hasPointSpecificOptions) {
			while (i--) {
				...
				// a specific marker controller object is defined for the individual point:
				...
				// no marker controller object is created: copy a reference to the series-wide
